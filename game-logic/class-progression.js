...
export const featDefinitions = {
    ...
    "Elemental Adept (Choose Type)": { class: "mage", level: 6, description: "Spells you cast ignore resistance to damage of the chosen type (Fire, Cold, Lightning, Thunder, Acid). In addition, when you roll damage for a spell that deals damage of that type, treat any 1 on a damage die as a 2.", effect: { chosen_element_ignore_resistance: true, chosen_element_treat_1_as_2_damage: true } },
